                ...
                <div class="responsiveDropdown w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent p-4 lg:p-0"
                    ...
                    <ul class="list-reset lg:flex justify-end flex-1 items-center responsiveDropdown">
                        <li class="relative mr-3 group">
                            <a class="inline-block py-2 px-4 text-white no-underline cursor-pointer font-bold nav-link responsiveDropdown"
                        ...
                        <li class="mr-3">
                            <a class="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4 font-bold nav-link responsiveDropdown"
                                href="/awards.html">
                                Awards
                            </a>
                        </li>
